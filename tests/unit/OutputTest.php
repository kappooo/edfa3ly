...
class OutputTest extends TestCase
{
    ...
    {
        $commandLineOutputObject = new CommandLineOutput(new CurrencyHandler(new CartHandler(['pants','t-shirt', 'shoes']), new EGP()));
    ...
    {
        $commandLineOutputObject = new CommandLineOutput(new CurrencyHandler(new CartHandler(['pants','t-shirt',]), new EGP()));
        $this->assertTrue(strpos($commandLineOutputObject->getOutputSentence(), 'Discounts') === false);
        $this->assertTrue(strpos($commandLineOutputObject->getOutputSentence(), 'Taxes: 0') !== false);
    }
}
